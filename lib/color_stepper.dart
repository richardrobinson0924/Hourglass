...
class ColorStepper extends StatefulWidget {
...
class _StepperState extends State<ColorStepper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ColorStepper oldWidget) {
...
//    if (!_isDark()) {
//      return widget.steps[index].isActive ? widget.accentColor : Colors.black38;
//    } else {
//      return widget.steps[index].isActive ? widget.accentColor : themeData.backgroundColor;
//    }
    ...
    if (widget.steps[index].isActive) return widget.accentColor;
        ...
        child: Row(
          children: <Widget>[
            FlatButton(
              ...
              color: _isDark() ? themeData.backgroundColor : widget.accentColor,
